...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('QuizJovi', style: GoogleFonts.nunitoSans(fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: const [
          Icon(Icons.search)
        ],
                ...
                Container(
                  ...
                  child: Row(
                    children: [ 
                      ...
                      Text('Atrologia', style: GoogleFonts.roboto())
                    ],
                  ),
                 ),
                Container(
            ...
            child: Card( 
              ...
              child: Column(
                children: [
                  ...
                  style: GoogleFonts.indieFlower(fontSize: 24, fontWeight: FontWeight.w300)),
                  ListTile(
